...
<template>
  <bubble-menu :editor="editor" :tippy-options="{ duration: 100 }">
    <div
      class="flex items-center bg-white shadow-lg rounded-lg border border-gray-200 p-1"
    >
      ...
      <div class="relative">
        ...
        <div
          ...
          class="absolute top-full left-0 mt-1 p-2 bg-white shadow-lg rounded-lg z-10"
        >
