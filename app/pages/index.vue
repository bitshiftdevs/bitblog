...
<template>
  <div class="min-h-screen bg-default text-highlighted">
    <!-- Hero Section -->
    <section
      class="relative overflow-hidden py-24 sm:py-32 bg-gradient-to-b from-primary/5 to-transparent"
    >
      <div
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-4xl mx-auto">
          ...
          <p
            class="text-xl md:text-2xl text-muted font-light mb-10 max-w-3xl mx-auto leading-relaxed"
          >
            Discover amazing stories, insights, and knowledge from our vibrant
    ...
    <section class="py-24 bg-default">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold mb-4 tracking-tight">Featured Posts</h2>
        ...
        <div
          v-else
          class="text-center py-20 bg-muted/20 rounded-3xl border border-default/50"
        >
    ...
    <section class="py-24 bg-muted/10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <LazyCategoryCardSkeleton v-for="i in 8" :key="i" />
        </div>
    ...
    <section class="py-24 relative overflow-hidden">
      <div
        class="absolute inset-0 bg-gradient-to-r from-primary to-secondary opacity-10"
      ></div>
      <div
        class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center bg-background/50 backdrop-blur-md rounded-3xl p-12 border border-default/50 shadow-xl"
      >
        <h2 class="text-4xl font-bold mb-6">Stay Updated</h2>
        <p class="text-xl text-muted mb-10">
          Get the latest posts, exclusive content, and updates delivered
          straight to your inbox
        </p>
        <LazyNewsletterSignup class="max-w-md mx-auto" />
      </div>
    </section>
    <LogoSeparator />
    ...
    <section class="py-24 bg-default">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <LazyAuthorCardSkeleton v-for="i in 8" :key="i" />
        </div>
